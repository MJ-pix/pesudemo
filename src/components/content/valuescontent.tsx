...
const valuescontent = () => {
  ...
  <div
    className="flex flex-col rounded-lg sm:shrink-0 sm:grow sm:basis-0 sm:rounded-e-none items-center p-5 ">
      
      <img
        className="rounded-t-lg sm:rounded-tr-none h-32 mb-5"
        src={kotimainen}
        alt="Kotimainen" />
